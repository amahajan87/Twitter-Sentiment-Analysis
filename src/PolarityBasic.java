...
public class PolarityBasic {
    ...
    public DynamicLMClassifier<NGramProcessLM> run() throws ClassNotFoundException, IOException {
        ...
        /*
        System.out.println(mClassifier.classify("this movie is awesome").toString());
        System.out.println(mClassifier.classify("the movie is bad"));
        System.out.println(mClassifier.classify("the movie is good"));
        System.out.println(mClassifier.classify("the movie is very bad"));
        System.out.println(mClassifier.classify("the movie is very very bad"));*/
        return mClassifier;
    }
