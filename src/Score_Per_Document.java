 ...
 *
 */
public class Score_Per_Document {
	
	
	
	static String inputLocation = "C:\\Users\\Apurv Mahajan\\Downloads\\PDS\\News";
	static String outputLocation = "C:\\Users\\Apurv Mahajan\\Downloads\\PDS\\Score";
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException{
        ...
        try {
            ...
            ArrayList<String> nytimes = new ArrayList<String>(Arrays.asList("Yahoo","Symantec","Samsung","Netflix","Microsoft","Google",
																			"Facebook","Citrix","Cisco","Apple","Amazon","Akamai","Adobe"));
            																
            
        	ArrayList<String> cnn = new ArrayList<String>(Arrays.asList("Yahoo","TripAdvisor","Tesla","Symantec","Samsung"
						,"Netflix","NetApp","Microsoft","LinkedIn","Intel","Google","Facebook"
						,"Expedia","eBay","Citrix","Cisco","Broadcom"
						,"Apple","Amazon","Akamai","Adobe"));
        			

        	ArrayList<String> bloomberg = new ArrayList<String>(Arrays.asList("Google","Facebook","Expedia","eBay","Citrix","Cisco","Apple","Amazon","Akamai","Adobe"));
        	...
        	if (i==9){s = cnn; inputLocationURL = inputLocation + "/cnn"; outputLocationURL = outputLocation + "/cnn";}
        	if (i==9){s = nytimes; inputLocationURL = inputLocation + "/nytimes"; outputLocationURL = outputLocation + "/nytimes";}
        	if (i==0){s = bloomberg; inputLocationURL = inputLocation + "/bloomberg"; outputLocationURL = outputLocation + "/bloomberg";}		
        	
            for(String stock : s){
            
            File docFolder = new File(inputLocationURL + "/" + stock);
           ...
           File directoryOut =new File(outputLocationURL);
            ...
            directoryOut =new File(outputLocationURL + "/" + stock);
            if (!directoryOut.exists()) {
                if (directoryOut.mkdirs()) {
                    System.out.println("Directory is created!");
                } else {
            ...
            FileWriter f0 = new FileWriter(outputLocationURL + "/" + stock + "/" + "EachDocument_EachSentence" + "_Score");
            FileWriter f1 = new FileWriter(outputLocationURL + "/" + stock + "/" + "EachDocument_RelevantSentence" + "_Score");
            FileWriter f2 = new FileWriter(outputLocationURL + "/" + stock + "/" + "Monthly_EachSentence" + "_Score");
            FileWriter f3 = new FileWriter(outputLocationURL + "/" + stock + "/" + "Monthly_RelevantSentence" + "_Score");
